...
> **Note:** This snapshot was generated on 2026-02-18 and reflects the ONN repository state at that time. For the current research status, see the [ONN research status](/onn/onn-research-status-2026/) page.
...
| CE-1b | Scale-dependent bounds, $\|V\| \in \{1\text{K}, 10\text{K}, 100\text{K}\}$ | TESTED (59 runs, 100% pass) | test_core_tensors.py |
| CE-3a | Dense random graphs $p \in \{0.1, 0.3, 0.5, 0.7, 0.9\}$ | TESTABLE | tests/unit/*dense* |
