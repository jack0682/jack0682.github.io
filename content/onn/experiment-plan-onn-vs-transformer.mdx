...
> vs. Transformer comparison). Its asserted results exist only in two private,
> unreconciled historical drafts and **do not appear in the current authoritative
> research source** (`onn_ws/ONN`). Those drafts intentionally remain unpublished.
> The ONN
