...
track: perception
updated: 2026-04-26
summary: "Sections 8–9 of the SCC v2.3 canonical specification: the volume constraint, the four-term canonical energy functional, and the currently favored provisional realizations of closure, distinction, co-belonging, and temporal transport operators."
...
> **Part 3 of 5** — Soft Cognitive Cohesion canonical specification v2.3 (aligned with Perception_theory canonical CV-1.4, 2026-04-26).
...
<Figure
  ...
  alt="Schematic showing the canonical energy E(u) decomposing into four boxed terms: closure, separation, boundary/morphology, transport."
  caption={<>Four conceptually independent structural requirements assembled into the canonical energy E(u). Closure (self-support under relational completion), separation (asymmetry vs exterior field), boundary/morphology (smooth interface + double-well), and transport (temporal inheritance) — each penalty is structurally distinct, though they interact mathematically (CN5).</>}
