...
<Figure
  ...
  caption={<>Soft cohesion field u_t : X_t → [0,1] on a 2D grid — the primitive entity of the theory. Level contours at 0.1, 0.3, 0.5, 0.7, 0.9 show the graded transition from interior (high u) to exterior (low u). Crisp object-like regions are derivative limits of this field.</>}
