...
track: perception
updated: 2026-04-12
summary: "Sections 6–7 of the SCC v2.1 canonical specification: the five axiomatic groups (closure, adjacency, co-belonging, distinction, temporal transport) and the proto-cohesion diagnostic vector with its four component predicates."
...
> **Part 2 of 5** — Soft Cognitive Cohesion canonical specification v2.1.
