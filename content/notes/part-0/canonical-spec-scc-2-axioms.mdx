...
track: perception
updated: 2026-04-27
summary: "Sections 6–7 of the SCC canonical specification (CV-1.5): the five axiomatic groups (closure, adjacency, co-belonging, distinction, temporal transport) and the proto-cohesion diagnostic vector with its four component predicates."
...
> **Part 2 of 5** — Soft Cognitive Cohesion canonical specification, current release **CV-1.5** (2026-04-27).
