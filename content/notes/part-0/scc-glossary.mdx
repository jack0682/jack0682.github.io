...
track: perception
updated: 2026-05-04
summary: "Plain-language definitions of all formal SCC concepts — formal ID, intuitive description, why it matters, concrete analogy. Aligned with canonical CV-1.5.2: covers multi-formation vocabulary (Commitment 16 K-status, σ-tuple, OP-0008/0009) and L1-J / T-L1-F Hard-Bar / Active-Count Bridge."
...
→ 68 Cat A / 19 Cat B / 6 Cat C / 5 Retracted = 98 claims / ~70% fully proved (CV-1.17, 2026-05-15). Single-formation results are solid. Multi-formation persistence regimes are conditional, the foundational F-1 / M-1 / MO-1 issues are resolved (W4), and the first multi-formation Cat A theorem (T-L1-F Hard-Bar / Active-Count Bridge under the L1-J regime) was promoted at CV-1.5.2.
