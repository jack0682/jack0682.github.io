...
track: perception
updated: 2026-08-09
summary: "Historical SCC overview at the CV-1.11 snapshot, with the final CV-1.17 ledger linked. SCC is sealed and archived; current Main research moved to ULR on 2026-07-24."
tags: [scc, overview, perception]
draft: false
---

<Callout tone="warning" title="Historical overview">
SCC is a sealed historical programme. This active-era overview is preserved
for its mathematical content; it does not describe the current research
priority. Continue at the [ULR hub](/ulr/) or read the
...
> **Current canonical: CV-1.17** (68 Cat A / 19 B / 6 C / 5 Retracted = 98 claims, ~70% proved, sealed 2026-05-15). This overview is the **CV-1.11 (W6)** snapshot; the CV-1.12–1.17 additions and the current roadmap live in the [status page](/notes/part-0/scc-status-2026-05/).
...
Two SCC manuscripts — *"Self-Referential Phase Fields on Graphs"* (math focus, target: Journal of Mathematical Physics) and *"Before Objects: Pre-Objective Perceptual Cohesion"* (cognitive science focus, target: Cognitive Science) — were **deleted from `CODE/papers/` on 2026-05-04** as part of the W6 canonical audit, to be rewritten from scratch against the CV-1.11 (78-claim) baseline. They will appear on [/papers/](/papers/) when ready.

The closest published-side work is the [*Axiomatic Framework for Understanding Relations via Gauge-Invariant Cohomology*](/papers/axiomatic-cohomology-relations/), which establishes the relational substrate underpinning SCC.
...
- **H-SINK (unblocked):** Prove Sinkhorn-Lipschitz bound $L_g \leq L_c$ in the SCC cost class (Bigot-Cazelles-Papadakis 2019) → unlocks T-Temporal-Identity (a,b,d) Cat A → **CV-1.12 (+3A, 57A total)**. Dependency: P-F-A1 Package I (CV-1.9, complete).
...
*Last updated: 2026-05-09 | CV-1.11 (2026-05-06) | 54A / 14B / 5C / 5R = 78 claims (~69% proved) | OP-0006 RESOLVED | OP-0005 3-way split (EQ partial, OBS partial, DYN open) | OMS-2.0 Accepted — Full | Next: CV-1.12 via H-SINK | Most-recent narrative: [Week 6 weekly post](/journal/2026-05-08-perception-week-6/)*
