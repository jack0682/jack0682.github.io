...
- NQ-187 measured the scaling exponent $p \approx 1.03$ at $L = 16$ on $D_4$ free-BC for $\Delta\mu = \mu_1 - \mu_0$ vs $\epsilon$ (canonical predicts $p = 2$), with $\mu_0/\epsilon \approx 1$ and $\mu_1/\epsilon \approx 2$ — i.e. the discrete-grid amplitude ratio reads $A_2/A_1 \approx 2$, while canonical predicts $A_2/A_1 = 4$ in the continuum limit.
...
- Three reconciliation hypotheses (α continuum extrapolation, β R22 re-derivation, γ $\Sigma_m$-Hessian convention) are under audit.
